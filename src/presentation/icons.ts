...
<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
  <path d="M5 4h3.5l1.7 4.2-2.1 1.3a12 12 0 0 0 6.4 6.4l1.3-2.1L20 15.5V19a2 2 0 0 1-2.2 2A16 16 0 0 1 3 6.2 2 2 0 0 1 5 4z"></path>
</svg>`;
...
<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
  <path d="M3 11l13-6v14L3 13z"></path>
  <path d="M16 8.5a3.5 3.5 0 0 1 0 7"></path>
</svg>`;
